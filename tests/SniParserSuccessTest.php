...
final class SniParserSuccessTest extends TestCase
{
     ...
     * 测试成功解析SNI主机名
     */
    public function testParseSNISuccess(): void
    {
     ...
     * 测试解析不同长度的主机名
     */
    public function testParseSNIWithDifferentHostLengths(): void
    {
        // 测试短主机名
     ...
     * 测试解析包含特殊字符的主机名
     */
    public function testParseSNIWithSpecialChars(): void
    {
        // 包含连字符和数字的主机名
