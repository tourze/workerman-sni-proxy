 ...
 * @internal
 */
#[CoversClass(ProxyConfiguration::class)]
final class ProxyConfigurationTest extends TestCase
{
     ...
     * 测试远程主机列表为空时，允许所有主机
     */
    public function testGetAllowedTargetWithEmptyRemoteHosts(): void
    {
        $config = new ProxyConfiguration();
     ...
     */
    public function testGetAllowedTargetWithHostInAllowedList(): void
    {
     ...
     */
    public function testGetAllowedTargetWithHostNotInAllowedList(): void
    {
        $config = new ProxyConfiguration('0.0.0.0', 443, [
            'example.com:443',
            'test.com:8080',
     ...
     * 测试获取远程主机列表
     */
    public function testGetRemoteHosts(): void
    {
        $config = new ProxyConfiguration('0.0.0.0', 443, [
            'example.com:443',
            'test.com:8080',
