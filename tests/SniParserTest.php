 ...
 * @internal
 */
#[CoversClass(SniParser::class)]
final class SniParserTest extends TestCase
{
     ...
     * 测试缓冲区太小的情况
     */
    public function testParseSNIWithTooSmallBuffer(): void
    {
     ...
     * 测试非SSL/TLS握手类型的情况
     */
    public function testParseSNIWithNonTLSHandshake(): void
    {
     ...
     * 测试会话ID长度导致溢出的情况
     */
    public function testParseSNIWithSessionIdOverflow(): void
    {
     ...
     * 测试密码套件长度导致溢出的情况
     */
    public function testParseSNIWithCipherSuitesOverflow(): void
    {
     ...
     * 测试压缩方法长度导致溢出的情况
     */
    public function testParseSNIWithCompressionMethodsOverflow(): void
    {
     ...
     * 测试扩展长度导致溢出的情况
     */
    public function testParseSNIWithExtensionsOverflow(): void
    {
     ...
     * 测试包含SNI扩展但不完整的情况
     */
    public function testParseSNIWithIncompleteSNIExtension(): void
    {
        // 创建基本的TLS握手缓冲区直到扩展部分
        $buffer = chr(0x16) . str_repeat('x', 42);
        $buffer[43] = chr(0); // 会话ID长度为0
